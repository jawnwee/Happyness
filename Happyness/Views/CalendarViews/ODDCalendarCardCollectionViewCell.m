...
- (void)setupNoteLabel {
    ...
    _noteLabel.font = [UIFont fontWithName:@"SourceSansPro-Regular" size:12.0];
...
- (void)setupDateLabel {
    ...
    _dateLabel.font = [UIFont fontWithName:@"Nunito-Bold" size:18.0];
...
- (void)setHappynessEntry:(ODDHappynessEntry *)happynessEntry {
    ...
    _dateLabel.shadowColor = [[ODDCustomColor customColorDictionary]
                              objectForKey:
...
- (CGRect)createNoteFrame {
    CGRect noteFrame;
    if (IS_IPHONE_5) {
        noteFrame = CGRectMake(5.0, 110.0, 110, 70);
    } else {

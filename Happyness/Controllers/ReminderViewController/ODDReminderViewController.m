...
- (void)viewDidLoad {
    ...
    [self setUpSwitch];
    [self setUpPicker];
    if (![[NSUserDefaults standardUserDefaults] objectForKey:@"ReminderSwitch"]) {
        [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithBool:YES]
                                                  forKey:@"ReminderSwitch"];
        ...
        BOOL reminder = [[[NSUserDefaults standardUserDefaults] objectForKey:@"ReminderSwitch"] boolValue];
        CGRect slideFrame = self.reminderSwitch.frame;
        if (reminder) {
            [self turnOnPicker];
            [self turnOnReminderSwitch];
            ...
            [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithBool:YES] forKey:@"ReminderSwitch"];
        } else {
            [[NSUserDefaults standardUserDefaults] setObject:[NSNumber numberWithBool:NO] forKey:@"ReminderSwitch"];
        }
    }
}
...
- (void)switchToggled {
    CGRect slideFrame = self.reminderSwitch.frame;
    self.reminderIsOn = ![[[NSUserDefaults standardUserDefaults] objectForKey:@"ReminderSwitch"]  boolValue];
